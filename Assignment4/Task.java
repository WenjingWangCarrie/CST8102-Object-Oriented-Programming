public class Task {
	...
	public void setTitle(String title) throws ValidationException {
		...
		if (title == null) {
			...
			throw new ValidationException("Title cannot contains tab");
		} else {
	...
	public String toString() {
		...
		if (isComplete) {
			sb.append(" " + title).append(" (" + priority + ") ").append("is complete");
		} else {
			sb.append(" " + title).append(" (" + priority + ") ").append("is not complete");
		}
	...
	public String createTabRecord() {
		return "***\t" + title + "\t" + priority + "\t" + isComplete;
