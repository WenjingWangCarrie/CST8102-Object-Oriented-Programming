...
public class Company {
	...
	public void addEmployee() {
		if (totalEmployees == MAXNUMEMPLOYEES) {
			...
			case 1:
				double salary = 0.0;
				e = new Executive(name, startDate, salary);
				break;
		...
		if (totalEmployees == 0) {
			...
			for (int i = 0; i < totalEmployees; i++) {
				...
				if (employee instanceof Executive) {
					Executive exe = (Executive) employee;
	...
	public void findLongestEmployee() {
		if (totalEmployees == 0) {
			...
			System.out.println("Employee employed for the longest is " + em.getName() + " for " + maxDays + " days");
		}
	}
}
